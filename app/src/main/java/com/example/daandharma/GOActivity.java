...
public class GOActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goactivity);
        ...
        getSupportActionBar().setTitle("GOVERNMENTAL ORGANISATIONS");
        ...
        BacktoHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GOActivity.this, NavdrawerActivity.class));
            }
        });
                        ...
                        if(location != null){
                            ...
                            mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener(){
                                ...
                                public boolean onMarkerClick(Marker marker){
                                    for(int i = 0; i<arraylist.size(); i++){
                                        googleMap.animateCamera(CameraUpdateFactory.newLatLngZoom(arraylist.get(i),5));
                                    }
                                    String markertitle=marker.getTitle();
                                    Intent i = new Intent(GOActivity.this,DetailsActivity.class);
                            ...
                            Toast.makeText(GOActivity.this, "Please turn on your location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
